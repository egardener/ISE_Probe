...
# include "uFire_ORP_BLE.h"

bool uFire_ORP_BLE::connected() {
...
void uFire_ORP_BLE::startBLE() {
  // setup the server
  BLEDevice::init("uFire ORP");
...
void uFire_ORP_BLE::measureTemp() {
